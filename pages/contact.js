...
export default function Contact() {
    ...
    return (
        ...
        <div className="pt-24 mt-32 flex flex-col justify-center items-center">
            ...
            <div className='py-14  bg-gray-50 mt-14 w-full flex items-center justify-center space-x-8'>

                <div className='w-64 h-80 shadow-lg bg-white rounded-xl justify-between items-center flex flex-col py-8 px-4'>
            ...
            <div className='py-14 border-t-p flex w-full justify-center items-start space-x-8 divide-x-p'>

                <Link href='https://github.com/appwrite/appwrite'><a target='_blank' className='space-y-2 flex justify-center w-90 items-center space-x-4'>
                ...
                <Link href='https://github.com/appwrite/appwrite'><a target='_blank' className='pl-14 space-y-2 w-80 flex justify-center items-center space-x-6'>
                ...
                <Link href='https://twitter.com/NetIncTeam'><a target='_blank' className='pl-14 space-y-2 w-80 flex justify-center items-center space-x-6'>
