...
const FeatureCard = ({ title, data, icon }) => {
    ...
    return (
        <div className=" w-full  max-w-md lg:w-80 my-5 sm:mx-5 sm:h-72 bg-white shadow-sm  rounded-2xl flex flex-col justify-center items-center py-8 px-4  space-y-4">
